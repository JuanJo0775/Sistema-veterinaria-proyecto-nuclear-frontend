# microservices/notification_service/main_principal.py
import os
import sys
...
def main():
    ...
    try:
        ...
        create_health_endpoint(app, 'notification_service', db)
    except ImportError:
        create_health_endpoint(app, 'notification_service')

    logger.info("🚀 Notification Service iniciado en puerto 5003")
